...
protocol townList: class {
    func locationDataDownloaded(items:NSArray)
}

class MyTownClickSelecet: NSObject{
    var delegate: townList!
    var urlPath = "\(coreIP)clickTownList.jsp"
    ...
    func parseJSON(_ data: Data){
       ...
       // print(jsonResult.count)
        ...
        print("Board location pin clicked DispatchQueue")
        self.delegate.locationDataDownloaded(items: boardList)
//
