...
<%
	...
	try{
		...
		String query = "select board_Seqno,board_Title,board_Content,board_hit,board_Sido,board_Latitude,board_Longitude,board_InsertDate,board_isDone,board_Price,user_Id,board_uSeqno,image_String  from m_board, m_userInfo ,m_image,m_likes where m_board.board_uSeqno = m_userInfo.user_Seqno and board_DeleteDate is null and m_image.image_bSeqno = board_Seqno and board_Seqno = like_bSeqno and like_uSeqno = "+mySeqno+" order by board_Seqno desc";
